...
public class PageRequest extends Pojo {
	...
	public PageRequest(	int pageNo, int pageSize, int lastOffset, SortDirection sortDir, String sortField, Map<String, String> searchMap, Map<String, String> searchByOrMap) {
	...
	public PageRequest(	int pageNo, int pageSize, int lastOffset, Map<String, String> searchMap, Map<String, String> searchByOrMap) {
		setPage(pageNo, pageSize);
		this.lastOffset=lastOffset;
		this.searchMap = searchMap;
		this.searchByOrMap = searchByOrMap;
