...
export default {
  pages: {
    ...
    data: [
      ...
      {title: "Notice List",                url: "/apps/noticeboard/notice-list",       icon: "ListIcon",           is_bookmarked: false},
      {title: "Notice View",                url: "/apps/noticeboard/notice-view/268",   icon: "UserIcon",           is_bookmarked: false},
      {title: "Notice Edit",                url: "/apps/noticeboard/notice-edit/268",   icon: "EditIcon",           is_bookmarked: false},
