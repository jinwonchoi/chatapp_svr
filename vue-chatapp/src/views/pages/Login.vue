              ...
              <div class="p-8 login-tabs-container">
                ...
                <div>
                  <vs-input
                      ...
                      icon="icon icon-user"
                      icon-pack="feather"
                      label-placeholder="Your login id"
                      v-model="loginId"
                      class="w-full"/>
                  <span class="text-danger text-sm">{{ errors.first('loginId') }}</span>
...
export default{
  ...
  computed: {
    validateForm () {
      return !this.errors.any() && this.loginId !== '' && this.password !== ''
    }
  },
  methods: {
    checkLogin () {
